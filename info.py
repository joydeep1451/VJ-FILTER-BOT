...
API_ID = int(environ.get('23192358', ''))
API_HASH = environ.get('a64177945aed25dbd741d9b288121114', '')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('6990296924', '').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('-1002851585478', ''))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1002602260802', '').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://joydeep1451:<12x3nFBwznpgCK0E>@cluster0.yt6mhji.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', "")   # IF Multiple Database Is False Then Fill Only This Database Url.
